...
void Player::setVideoSink(const QGst::ElementPtr &sink) { m_videoSink = sink; }
...
void Player::open() {
  ...
  QString fileName = QFileDialog::getOpenFileName(qobject_cast<QWidget *>(parent()), tr("Open a Movie"), m_baseDir);

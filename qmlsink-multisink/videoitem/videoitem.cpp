...
static const QStringList patterns = {"smpte",       "snow", "black",    "white", "red",      "green",  "blue",     "checkers-1", "checkers-2", "checkers-4", "checkers-8", "circular", "blink", "smpte75", "zone-plate", "gamut", "chroma-zone-plate",
                                     "solid-color", "ball", "smpte100", "bar",   "pinwheel", "spokes", "gradient", "colors"};
...
VideoItem::VideoItem(QQuickItem *parent) : QQuickItem(parent), _priv(new VideoItemPrivate(this)) {
...
bool VideoItem::hasVideo() const { return _priv->renderPad && (state() & STATE_PLAYING); }

QString VideoItem::source() const { return _priv->pattern; }
...
VideoItem::State VideoItem::state() const { return _priv->state; }
...
QRect VideoItem::rect() const { return _priv->rect; }
...
QSize VideoItem::resolution() const { return _priv->resolution; }

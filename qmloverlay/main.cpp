...
SetPlaying::SetPlaying(GstElement *pipeline) { this->pipeline_ = pipeline ? static_cast<GstElement *>(gst_object_ref(pipeline)) : NULL; }
...
static void on_overlay_scene_initialized(GstElement *overlay, gpointer unused) {
